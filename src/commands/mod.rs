...
//         self.insert.world.contains(entity).then_some(EntityCommands {
//             entity,
//             commands: self,
//         })
//     }
...
//     /// ```
//     pub fn init_resource<R: 'static + FromWorld + Send + Sync>(&mut self) {
...
// impl<R: 'static + Send + Sync> Command for RemoveResource<R> {
//     fn apply(self, world: &mut World) {
//         todo!()
