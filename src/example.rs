...
mod test_mod {
    ...
    fn test_editor() {
        ...
        pub fn alter_add(mut edit: EntityEditor) {
            ...
            let e = edit.insert_components_by_index(&scomponents).unwrap();
    ...
    fn test_editor2() {
        ...
        pub fn insert_components_by_index(mut editor : EntityEditor ) {
        ...
        app.add_system(Update, insert_components_by_index);
        app.add_system(Update, query2);
        app.add_system(Update, query3);
